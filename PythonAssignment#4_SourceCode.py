...
#creating object
student1 = Student("Ravinder Kumar", 21103120)
print("Object created")
#printing the assigned values
print("The name of the student is "+str(student1.name)+" and SID is "+str(student1.roll_no))
#deleting object
del student1
...
employee1 = Employee("David", 40000)
employee2 = Employee("Daniela", 50000)
employee3 = Employee("Jason", 60000)

#part <a> updating salary
employee1.salary = 70000
print("<a> The updated salary of "+str(employee1.name)+" is "+str(employee1.salary))
#part <b> deleting a record
print("<b> Record of Jason deleted", end='')
del employee3
